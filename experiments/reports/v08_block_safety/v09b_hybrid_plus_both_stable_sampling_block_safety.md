...
- Block-specific scales: `{'commonsense_choice': 0.6, 'format_following': 0.75, 'chinese_semantic': 0.75, 'calculation_error': 0.3, 'short_reasoning': 0.45, 'arithmetic_power_log': 0.75, 'factual_constants': 0.75}`
...
| factual_constants | 0.620 | -0.210 | 1 | 26 | -25 | 0 | `{'chinese': 10, 'code': 2, 'commonsense': 4, 'math': 1, 'reasoning': 9}` |
