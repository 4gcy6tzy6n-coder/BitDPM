...
- Block-specific scales: `{'commonsense_choice': 0.6, 'format_following': 0.75, 'chinese_semantic': 0.75, 'calculation_error': 0.3, 'short_reasoning': 0.45, 'arithmetic_power_log': 0.75, 'v11_linear_equation': 0.75, 'v11_percent_time_distance': 0.75, 'v11_circle_area': 0.75, 'v11_stats_number_theory': 0.75, 'v11_factorial_derivative': 0.75}`
...
| v11_linear_equation | 0.820 | -0.010 | 1 | 2 | -1 | 0 | `{'commonsense': 1, 'math': 1}` |
| calculation_error | 0.810 | -0.020 | 1 | 3 | -2 | 0 | `{'commonsense': 3}` |
| chinese_semantic | 0.800 | -0.030 | 1 | 6 | -5 | 1 | `{'chinese': 4, 'commonsense': 1, 'math': 1}` |
| v11_stats_number_theory | 0.785 | -0.045 | 1 | 8 | -7 | 1 | `{'chinese': 6, 'commonsense': 2}` |
| arithmetic_power_log | 0.755 | -0.075 | 2 | 11 | -9 | 0 | `{'chinese': 3, 'code': 2, 'commonsense': 4, 'math': 1, 'reasoning': 1}` |
| v11_percent_time_distance | 0.710 | -0.120 | 1 | 14 | -13 | 0 | `{'chinese': 12, 'commonsense': 1, 'math': 1}` |
| v11_circle_area | 0.670 | -0.160 | 1 | 18 | -17 | 0 | `{'chinese': 12, 'commonsense': 4, 'math': 1, 'reasoning': 1}` |
| v11_factorial_derivative | 0.660 | -0.170 | 1 | 19 | -18 | 0 | `{'chinese': 13, 'commonsense': 2, 'math': 2, 'reasoning': 2}` |
...
- #33 `math`: What is the mean of 4, 8, 12, and 16?
