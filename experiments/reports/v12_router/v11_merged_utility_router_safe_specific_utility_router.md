...
- Choices: `{'baseline': 92, 'format_following': 4, 'chinese_semantic': 2, 'commonsense_choice': 1, 'arithmetic_power_log': 1}`
...
| has_sqrt | v11_circle_area | 1 | 0 | 1.000 | 1 |
| has_sqrt | v11_factorial_derivative | 1 | 0 | 1.000 | 1 |
| has_coordinate | arithmetic_power_log | 1 | 0 | 1.000 | 1 |
| has_distance | arithmetic_power_log | 1 | 0 | 1.000 | 1 |
| has_coordinate | v11_linear_equation | 1 | 0 | 1.000 | 1 |
| has_distance | v11_linear_equation | 1 | 0 | 1.000 | 1 |
| has_coordinate | v11_percent_time_distance | 1 | 0 | 1.000 | 1 |
| has_distance | v11_percent_time_distance | 1 | 0 | 1.000 | 1 |
