...
- Choices: `{'baseline': 279, 'v11_stats_number_theory': 19, 'format_following': 2}`
...
- #40 `arithmetic` v11_stats_number_theory via `has_coordinate`: What is the distance from (0,0) to (3,4)?
- #42 `arithmetic` v11_stats_number_theory via `has_coordinate`: What is the distance from (0,0) to (8,15)?
