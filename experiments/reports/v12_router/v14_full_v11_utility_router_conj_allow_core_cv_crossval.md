...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 57 | 8 | 0.842 | 0.807 | +0.035 | 2 | 0 |
| 1 | 61 | 5 | 0.869 | 0.852 | +0.016 | 1 | 0 |
| 2 | 63 | 6 | 0.778 | 0.746 | +0.032 | 2 | 0 |
| 3 | 63 | 9 | 0.889 | 0.889 | +0.000 | 0 | 0 |
| 4 | 56 | 8 | 0.911 | 0.911 | +0.000 | 0 | 0 |
...
- fold=1 #40 `arithmetic` v11_stats_number_theory via `category=arithmetic&has_coordinate`: What is the distance from (0,0) to (3,4)?
